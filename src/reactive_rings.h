 ...
 *
 * Colors in this version are modulated according to VisualMemory recall data.
 *
...
class ReactiveRingsEffect : public Effect
{
public:
    ReactiveRingsEffect(const char *palette, const VisualMemory *mem)
        : palette(palette), mem(mem)
    {
        reseed();
    }
    ...
    static const float brightnessContrast = 3.0;
    ...
    virtual void shader(Vec3& rgb, const PixelInfo &p) const
    {
        ...
        rgb = color(colorParam + r * 5.0, r * sq(n));
    }
